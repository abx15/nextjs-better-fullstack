  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        // Simple redirect to dashboard - middleware will handle role-based routing
  ...
  return (
    <div className="min-h-screen bg-gray-50" suppressHydrationWarning>
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-64px)]">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-[#1a3a6b] text-white p-12 flex-col justify-between" suppressHydrationWarning>
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="space-y-6 max-w-md mx-auto">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg">{mounted ? "बिल्कुल मुफ़्त — हमेशा" : "100% Free - Always"}</span>
              </div>
            </div>
          </div>
        ...
        {/* Right Panel - Form */}
        <div className="flex-1 bg-white p-4 sm:p-6 lg:p-12 flex items-center justify-center" suppressHydrationWarning>
